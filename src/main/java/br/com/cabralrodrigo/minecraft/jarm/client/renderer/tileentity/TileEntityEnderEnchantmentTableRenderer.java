...
public class TileEntityEnderEnchantmentTableRenderer extends TileEntitySpecialRenderer<TileEntityEnderEnchantmentTable> {
    private ModelBook bookModel = new ModelBook();

    @Override
    public void renderTileEntityAt(TileEntityEnderEnchantmentTable te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        this.bookModel.render((Entity) null, f, f3, f4, f5, 0.0F, 0.0625F);
